...
const CLARO = [205, 226, 251]; // #cde2fb
const ESCURO = [24, 79, 149]; // #184f95

function cor(valor, min, max) {
...
function construir(raiz, geo, avisar) {
  ...
  legenda.innerHTML = '<span>menos operadoras</span><span class="barra"></span><span>mais operadoras</span>';
...
export default function (component) {
  ...
  grupo.querySelectorAll(".estado").forEach((p) => {
    ...
    const v = valores[uf] || {};
    p.style.fill = cor(v.valor, min, max);
